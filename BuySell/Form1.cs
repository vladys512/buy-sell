...
{
    /// <summary>
    /// Головне вікно інформаційної системи «Біржа товарів».
    /// Забезпечує взаємодію користувача з базами даних клієнтів, 
    /// візуалізацію результатів пошуку та управління архівом угод.
    /// </summary>
    public partial class Form1 : Form
    {
        ...
        private void ShowHelpBulletin()
        {
            string helpText = "Ласкаво просимо до інформаційної системи «Біржа товарів»!\n\n" +
                                  "Ця програма створена для автоматизації оптової торгівлі та швидкого пошуку " +
                                  "взаємовигідних пропозицій між продавцями та покупцями.\n\n" +
                                  "Коротка інструкція з використання:\n" +
                                  "1. Реєстрація клієнтів: Натисніть кнопку 'Додати продавця' або 'Додати покупця', " +
                                  "заповніть усі поля форми та підтвердіть дію.\n\n" +
                                  "2. Видалення клієнтів: виділіть потрібного клієнта "
                                  + "та натисніть кнопку 'Видалити' або клавішу [Delete] та підтвердіть дію.\n\n" +
                                  "3. Пошук варіантів: оберіть запис клієнта у таблиці та натисніть кнопку 'Пошук варіантів'. " +
                                  "Програма автоматично підбере зустрічні пропозиції, які підходять за ціною та товаром.\n\n" +
                                  "4. Укладання угоди: на вкладці пошуку оберіть найкращий варіант та натисніть 'Оформити угоду'. " +
                                  "Система автоматично розрахує залишки товарів та збереже історію операції в 'Архіві угод'.\n\n" +
                                  "5. Друк оголошень: виділіть потрібного клієнта та натисніть кнопку друку, щоб " +
                                  "сформувати текстовий документ\n\n";
